...
ggsave(filename = paste0(dir_results, "fsom_tree_12x12meta20_healthyBM.pdf"), plot = p, height = 8.5, width = 11)
```
...
Plot2DScatters(fsom = fsom, channelpairs = channel_pairs, metaclusters = metaclusters_of_interest, clusters = clusters_of_interest, plotFile = paste0(dir_results, "fsom_2D_lymph_scatterplot_metacluster.png"), centers = FALSE, density=FALSE)
```
...
## STEP 5: Plot Tree with manual labels
...
celltype_colors <- c(
  ...
  "Mature Myeloids"       = "#984ea3",  # blue
  "Immature Myeloids"     = "#f20a90",  # green
  "Platelets"             = "#ffff33",  # purple
  "Blasts"                = "#4daf4a",  # brown
  "CD36-/CD71+ cells"     = "#f781bf",  # pink
  "Eosinophils"           = "#377eb8",  # grey
  "Debris"                = "#000000",  # light grey
  "Mature Monocytes"      = "#253bfc",  # teal
  "Lymphocytes"           = "#23f8d6",  # yellow
  "Other"                 = "#bcbcbc"   # neutral light grey
)
...
# Add metacluster labels to FlowSOM object
...
ggsave(filename = paste0(dir_results, "fsom_tree_15x15meta20_aml_manual.pdf"), plot = p, height = 8.5, width = 13)
```
